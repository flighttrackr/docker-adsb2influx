...
class SBSHost(object):
    ...
    def receive(self):
        ...
        try:
            ...
            raise AdsbError('Error receiving data from SBS host: \'{}\''.format(e))
...
def main():
    parser = argparse.ArgumentParser(
        description = 'Write ADSB data from SBS host to InfluxDB 2.0'
    )
    ...
    parser.add_argument(
        ...
        dest = 'sbs_host',
        default = 'localhost',
        help = 'SBS host/ip (default: localhost)'
    )
    parser.add_argument(
        '-sp', '--sbs-port',
        dest = 'sbs_port',
    ...
    # SBS
    sbs = SBSHost(args.sbs_host, args.sbs_port)
    sbs.connect()
